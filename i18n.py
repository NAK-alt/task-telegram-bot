...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "km": {
        ...
        "wizard_prompt_deadline": "⏰ ជ្រើសរើសកាលបរិច្ឆេទកំណត់ (Deadline) សម្រាប់៖ '%s'\n\nសូមជ្រើសរើសប៊ូតុងខាងក្រោម ឬ វាយបញ្ចូលកាលបរិច្ឆេទផ្ទាល់ (ឧទាហរណ៍៖ 2026-08-20 17:00 ឬ 20/08/2026)៖",
    ...
    "en": {
        ...
        "wizard_prompt_deadline": "⏰ Select deadline for: '%s'\n\nChoose a quick button below OR type custom date & time (e.g., 2026-08-20 17:00 or 20/08/2026):",
